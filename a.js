...
function buildResume(details){
    ...
    document.getElementById('resume_name').value=details.name;
    document.getElementById('resume_email').value=details.email;
    document.getElementById('resume_contact').value=details.contact;
    document.getElementById('resume_address').value=details.address;
    document.getElementById('resume_tech1').value=details.tech1;
    document.getElementById('resume_tech2').value=details.tech2;
    document.getElementById('resume_tech3').value=details.tech3;
    document.getElementById('resume_tech4').value=details.tech4;
    document.getElementById('resume_pro1').value=details.pro1;
    document.getElementById('resume_pro2').value=details.pro2;
    document.getElementById('resume_pro3').value=details.pro3;
    document.getElementById('resume_pro4').value=details.pro4;
    document.getElementById('resume_pro5').value=details.pro5;
    document.getElementById('resume_lang1').value=details.lang1;
    document.getElementById('resume_lang2').value=details.lang2;
    document.getElementById('resume_lang3').value=details.lang3;
    document.getElementById('resume_ug_year').value=details.ug_year;
    document.getElementById('resume_ug_course').value=details.ug_course;
    document.getElementById('resume_ug_percentage').value=details.ug_percentage;
    document.getElementById('resume_ug_institution').value=details.ug_institution;
    document.getElementById('resume_ug_board').value=details.ug_board;
    document.getElementById('resume_inter_year').value=details.inter_year;
    document.getElementById('resume_inter_course').value=details.inter_course;
    document.getElementById('resume_inter_percentage').value=details.inter_percentage;
    document.getElementById('resume_inter_institution').value=details.inter_institution;
    document.getElementById('resume_inter_board').value=details.inter_board;
    document.getElementById('resume_tenth_year').value=details.tenth_year;
    document.getElementById('resume_tenth_course').value=details.tenth_course;
    document.getElementById('resume_tenth_percentage').value=details.tenth_percentage;
    document.getElementById('resume_tenth_institution').value=details.tenth_institution;
    document.getElementById('resume_tenth_board').value=details.tenth_board;
    document.getElementById('resume_interest1').value=details.interest1;
    document.getElementById('resume_interest2').value=details.interest2;
    document.getElementById('resume_interest3').value=details.interest3;
